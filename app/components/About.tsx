...
export default function About() {
  return (
    <section id="about" className="py-35 px-[6%] bg-charcoal border-t border-line border-b">
      ...
      <div className="max-w-250 mx-auto grid md:grid-cols-2 gap-15 items-center">
        <motion.div
          initial={{ opacity: 0, y: 28 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-80px" }}
          transition={{ duration: 0.9 }}
        >
          <p className="text-[15.5px] leading-[2.05] text-[#c9c2ac] mb-4.5">
        ...
        <motion.div
          ...
          className="border border-line rounded-sm p-9"
          style={{
