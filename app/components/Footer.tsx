...
export default function Footer() {
  return (
    <footer className="border-t border-line mt-10 px-[6%] py-15 bg-black">
      <div className="max-w-[1100px] mx-auto grid md:grid-cols-[1.4fr_1fr_1fr] gap-10">
        <div>
          <a
            href="#"
            className="flex items-center gap-3 no-underline mb-[14px]"
          >
          ...
          <p className="text-[13px] text-muted leading-[1.9] max-w-[300px]">
        ...
        <div>
          ...
          <a
            href="#about"
            className="block text-[13.5px] text-[#c9c2ac] no-underline mb-[10px] hover:text-gold-light"
          >
            درباره ما
          </a>
          <a
        ...
        <div>
          ...
          <p className="text-[13.5px] text-[#c9c2ac] mb-[10px]">۰۹۱۲۳۷۰۱۶۹۱</p>
          <p className="text-[13.5px] text-[#c9c2ac] mb-[10px]">
      ...
      <div className="max-w-[1100px] mx-auto mt-[50px] pt-6 border-t border-line text-center text-xs text-muted">
